-- Jalankan di Supabase SQL Editor untuk fitur Data Penduduk.
...
select 'Tabel public.penduduk siap dipakai. Jika website masih error schema cache, tunggu 10-30 detik lalu refresh halaman.' as status;
